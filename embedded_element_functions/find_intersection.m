...
% faces2(1,:) = [h2_connect(4) h2_connect(3) h2_connect(2) h2_connect(1)];
% faces2(2,:) = [h2_connect(1) h2_connect(2) h2_connect(6) h2_connect(5)];
% faces2(3,:) = [h2_connect(2) h2_connect(3) h2_connect(7) h2_connect(6)];
% faces2(4,:) = [h2_connect(3) h2_connect(4) h2_connect(8) h2_connect(7)];
% faces2(5,:) = [h2_connect(1) h2_connect(5) h2_connect(8) h2_connect(4)];
% faces2(6,:) = [h2_connect(5) h2_connect(6) h2_connect(7) h2_connect(8)];
